...
import { elementsData5 } from '../dataElements.js'
import { Card, Button, Paragraph, TextInput, ToggleButton } from 'react-native-paper'
import { GoogleSignin } from '@react-native-google-signin/google-signin'

const elements = elementsData5
const title = 'Pochylnie'
		...
		<ScrollView style={{}}>
			<View style={{ marginHorizontal: 10 }}>
				<Button
					icon='camera'
					mode='contained'
					onPress={() => navigation.navigate('CameraScreen', { title: `Pochylnie - ` + comments[0][0] })}
					style={styles.button}>
					Aparat
				</Button>
