const elementsData1 = [
	...
	},
	{
		...
		content: [
			'1.3.1.Ilość stopni w jednym biegu poniżej 10.',
			'1.3.2.Szerokość: biegu 1,2 m, szerokość spocznika 1,5 m.',
			'1.3.3.Głębokość stopni min. 35 cm, wysokość stopni max. 17,5 cm.',
			'1.3.4.Schody zewnętrzne i wewnętrzne, służące do pokonania wysokości przekraczającej 50 cm, są z balustradą lub innym zabezpieczeniem od strony przestrzeni otwartej, o wysokości 110 cm.',
			'1.3.5.Przy szerokości biegu schodów większej niż 4 m należy zastosować dodatkową balustradę pośrednią.',
			'1.3.6.Schody zewnętrzne - dodatkowa balustrada pośrednia',
			'1.3.7.Maksymalny prześwit lub wymiar otworu pomiędzy elementami wypełnienia balustrady nie jest większy niż 12 cm.',
			'1.3.8.Zastosowano poręczę na wysokości 85-100 cm pierwszą.',
			'1.3.9.Dodatkowo na wysokości 60-75 cm drugą, szczególnie zalecane gdy w budynku znajdują się dzieci.',
			'1.3.10.Poręcze przy schodach przed ich początkiem i za końcem są przedłużone o min. 30 cm w poziomie użytkowania.',
			'1.3.11.Poręcze przy schodach oddalone od ścian, do których są mocowane, co najmniej 5 cm.',
			'1.3.12.Część chwytna poręczy ma średnicę w zakresie 3,5 cm - 4,5 cm.',
			'1.3.13.Na końcach poręczy są zamontowane oznaczenia dotykowe (pismo wypukłe lub piktogramy dotykowe) i w alfabecie braillea.',
			'1.3.14.Końce poręczy są zawinięte w dół lub zamontowane do ściany, tak aby nie można było zaczepić się fragmentami ubrania.',
			'1.3.15.Zapewniono ciągłość prowadzenia poręczy na schodach wielobiegowych.',
			'1.3.16.Linia poręczy jest wiernie odzwierciedlać bieg schodów.',
			'1.3.17.W odległości maks. 50 cm przed krawędzią pierwszego stopnia schodów w dół oraz przed krawędzią pierwszego stopnia schodów w górę, ułożono fakturę ostrzegawczą o szerokości nie mniejszej niż 40 cm i nie większej niż 60 cm.',
			'1.3.18.Powierzchnie spoczników schodów powinny mieć wykończenie wyróżniające je odcieniem, barwą bądź fakturą, min. w pasie 30 cm od krawędzi rozpoczynającej i kończącej bieg schodów.',
			'1.3.19.Wszystkie krawędzie stopni są oznaczone przy pomocy kontrastowego pasa o szerokości 5 cm umieszczonego wzdłuż całej krawędzi stopni w poprzek biegu.',
			'1.3.20.Zachowano bezpieczną skrajnię ruchu pieszych i gdy bieg schodowy jest nadwieszony nad ciągiem pieszym, przestrzeń pod schodami o wysokości mniejszej niż 220 cm powinna być obudowana lub oznaczona.',
		],
	},
	{
		name: 'WYPOSAŻENIE ZEWNĘTRZNE',
		content: [
			'1.4.1.	Ławki wyposażone w oparcia i podłokietniki (przynajmniej 1/3 miejsc siedzących).',
			'1.4.2.	Zapewniono miejsca postojowe dla rowerów.',
		],
	},
	{
...
const elementsData2 = [
	...
	},
	{
		...
		content: [
			...
			'2.2.4.	Odpowiednie oznaczenie pionowe (znak pionowy d18a "parking  miejsce zastrzeżone" wraz z tabliczką t 29 informująca o miejscu dla osoby niepełnosprawnej',
			'2.2.5.	Wskaźnik odbicia światła słonecznego w wartości co najmniej 0,33',
			'2.2.6.	Wykonana z odpowiedniego materiału',
		],
	},
]
...
const elementsData5 = [
	...
	},
	{
		name: 'Nachylenie',
		content: [
			'5.2.1.Różnica wysokości do 15 cm   max nachylenie 15% (wewnętrzne lub pod daszkiem)',
			'5.2.2.Różnica wysokości do 50 cm   max nachylenie 10% (wewnętrzne lub pod daszkiem)',
			'5.2.3.Różnica wysokości powyżej 50cm   max nachylenie 8% (wewnętrzne lub pod daszkiem)',
			'5.2.4.Różnica wysokości do 15 cm   max nachylenie 15% (na zewnątrz)',
			'5.2.5.Różnica wysokości do 50cm   max nachylenie 10% (na zewnątrz)',
			'5.2.6.Różnica wysokości powyżej 50cm   max nachylenie 6% (na zewnątrz)',
		],
	},
	{
		name: 'Poręcze',
...
const elementsData9 = [
	...
	},
	{
		...
		content: [
			...
			'9.3.5.Zastosowano poręczę na wysokości 85  100 cm pierwszą',
			'9.3.6.Dodatkowo na wysokości 60  75 cm drugą',
			'9.3.7.Poręcze przy schodach przed ich początkiem i za końcem są przedłużone o min. 30 cm w poziomie oraz zakończyć w sposób zapewniający bezpieczne użytkowanie',
			'9.3.8.Poręcze przy schodach oddalone od ścian, do których są mocowane, co najmniej 5 cm',
			'9.3.9.Część chwytna poręczy ma średnicę w zakresie 3,5 cm  4,5 cm',
			'9.3.10.Na końcach poręczy są zamontowane oznaczenia dotykowe (pismo wypukłe lub piktogramy dotykowe) i w alfabecie braillea,',
			'9.3.11.Końce poręczy są zawinięte w dół lub zamontowane do ściany, tak aby nie można było zaczepić się fragmentami ubrania,',
			'9.3.12.Zapewniono ciągłość prowadzenia poręczy na schodach wielobiegowych',
			'9.3.13.Dopuszczono przerwanie ciągłości poręczy w przypadku spoczników o długości większej niż 3 m',
			'9.3.14.Poręcze są w kolorze kontrastującym z tłem ściany',
			'9.3.15.Linia poręczy jest wiernie odzwierciedlać bieg schodów',
		],
	},
	{
		name: 'OZNACZENIA',
...
const elementsData10 = [
	...
	},
	{
		...
		content: [
			'10.1.1. Wszystkie istone kondygnacje są dostępne dla osób niemogących się samodzielnie poruszać poprzez dzwigi osobowe i platformy',
			'10.1.2. Odległość drzwi dźwigu od ściany/przeszkody  min 1,6m',
			'10.1.3. Informacja o kondygnacji',
			'10.1.4. Numer czytelny przez dotyk',
			'10.1.5. Wypukłe cyfry min. 4 cm lub napisane alfabetem braillea po obu stronach ościeżnicy',
			'10.1.6. Obramowanie jest oznakowane w sposób kontrastowy w stosunku do otoczenia',
			'10.1.7. Na dojściu do dźwigu zastosowano system fakturowy prowadzący do panelu przywoławczego',
		],
	},
	{
		name: 'WYMIARY KABINY ORAZ JEJ WYPOSAŻENIE',
		content: [
			'10.2.1.Kabina ma szerokość co najmniej 110 cm',
			'10.2.2.Kabina ma długość co najmniej  140 cm',
			'10.2.3.Po obu stronach kabiny znajdują się ciągłe poręcze',
			'10.2.4.Poręcze   ich górna część na wysokości 90 cm,',
			'10.2.5.W poręczy jest przerwa jeżeli kabinowy panel sterujący znajduje się na tej samej ścianie',
			'10.2.6.Różnica poziomów podłogi kabiny, zatrzymującego się na kondygnacji użytkowej,i posadzki tej kondygnacji przy wyjściu z dźwigu nie jest większa niż 2 cm (optymalnie do 1 cm),',
			'10.2.7.Drzwi do kabiny mają szerokość 90 cm (zalecana 100 cm)',
			'10.2.8.Drzwi dźwigu otwierają się i zamykać automatycznie',
			'10.2.9.System  oparty na czujnikach (np. Podczerwień) zatrzymujących zamykanie drzwi jeszcze przed kontaktem fizycznym z przedmiotem lub osobą,',
			'10.2.10.Na ścianie przeciwnej do drzwi wejściowych jest  lustro  (jeśli kabina jest min. 150x150cm  nie jest konieczne)',
			'10.2.11.Lustro, na wysokości maksymalnie 40 cm od poziomu podłogi',
			'10.2.12.Kabina, jak i szyb są przeszklone',
			'10.2.13.Kabina dźwigu i panele kontrolne są dobrze oświetlone',
		],
	},
	{
		name: 'ZEWNETRZNY PANEL STERUJACY',
		content: [
			'10.3.1.Zewnętrzny panel sterujący na wysokości 80  120 cm od posadzki',
			'10.3.2.Przy każdych drzwiach do dźwigu należy umieścić sygnalizację świetlną i dźwiękową',
			'10.3.3.Pojedynczy sygnał dźwiękowy oznacza wjazd do góry, podwójny zjazd na dół',
			'10.3.4.Panele z wypukłymi klawiszami',
		],
	},
	{
		name: 'WEWNĘTRZNY PANEL STERUJĄCY',
		content: [
			'10.4.1.Panel sterujący w kabinie na wysokości 80  120 cm nad podłogą',
			'10.4.2.Panel sterujący w kabinie w odległości 50 cm od naroża kabiny',
			'10.4.3.W przypadku drzwi otwieranych centralnie: po prawej stronie wejścia do kabiny',
			'10.4.4.W przypadku drzwi otwieranych jednostronnie: po stronie zgodnej z kierunkiem zamykania drzwi,',
			'10.4.5.Przyciski piętrowe nad przyciskami alarmu i drzwi',
			'10.4.6.Przyciski pojedyncze: w jednym rzędzie, pionowo lub poziomo',
			'10.4.7.W przypadku większej ilości przycisków rozmieszczenie mijankowe',
			"10.4.8.Wyposażony w dodatkowe oznakowanie dla osób niewidomych i niedowidzących (wypukłe opisy, cyfry lub symbole oraz oznaczenia w alfabecie braille'a) oraz informację głosową,",
			'10.4.9.Przycisk przystanku wyjściowego z budynku wystaje 5 mm (+/ 1 mm) ponad pozostałe przyciski (zalecany kolor zielony)',
		],
	},
	{
		name: 'PLATFORMY PIONOWE I UKOŚNE',
		content: [
			'10.5.1.Wysokość podnoszenia bez szybu i wewnątrz budynku do 3m',
			'10.5.2.Wysokość podnoszenia z szybem do 12m',
			'10.5.3.Podnośnik pionowy – min. 90x140 cm, przy udźwigu nie mniejszym niż 315 kg,',
			'10.5.4.Podnośnik schodowy – min. 75x100 cm, przy udźwigu nie mniejszym niż 250 kg',
			'10.5.5.Podłoga antypoślizgowa',
			'10.5.6.Platforma podnośnika wyposażona w barierki',
			'10.5.7.Jeżeli przy wejściu zamontowano platformę umożliwia samodzielne korzystanie',
			'10.5.8.Możliwość wezwania pracownika obiektu',
		],
	},
]
...
const elementsData13 = [
	...
	},
	{
		name: 'PRZESTRZEŃ MANEWROWA',
		content: [
			'13.1.1. Obrót o 90 stopni – 150x150 cm',
			'13.1.2. Pełen obrót (średnia koła wózka) - 160x160 cm',
			'13.1.3. Skręt w czasie jazdy o 90 stopni - 150x180 cm',
		],
	},
	{
		name: 'BIURKO',
		content: [
			'13.2.1. Wysokość blatu biurka lub stou od 60 cm do 80 cm',
			'13.2.2. Przestrzeń na nogi pod stołem/biurkiem',
			'13.2.3	Półki wiszące nad biurkiem na wysokości 120 - 130 cm od powierzchni podłogi',
		],
	},
	{
		name: 'OŚWIETLENIE',
		content: [
			'13.3.1. Oświetlenie wewnątrz budynku jest równomierne, ogranicza zjawisko olśnienia',
	...
	},
	{
		name: 'OKNA',
		content: [
			'13.4.1. Klamka w postaci dźwigni na wysokości 85-120 cm nad poziomem podłogi',
			'13.4.2. Klamka w kontrastujących barwach w stosunku do tła',
	...
	},
	{
		...
		content: [
			'13.5.1. Kontakty i inne mechanizmy kontrolne na wysokości 80 - 110 cm',
			'13.5.2. Gniazda na wysokości 40-100 cm',
	...
	},
	{
		...
		content: [
			'13.7.1. Szerokość skrzydła drzwi większa niż 90 cm (bez pom. Technicznych)',
			'13.7.2. Kontrastowe ościeżnice',
			'13.7.3. Wyróżniająca się klamka',
			"13.7.4. Info w alfabecie braille'a na 120 cm",
			'13.7.5. Nr pokoju wyrazisty, Na wysokości 145-165 cm',
		],
	},
]
